...
from base.plugins.custom_filters import is_member_filter, ban_check_filter, search_credit_filter


# Main plugin, Search picture on google
@Client.on_message(filters.photo & filters.private &\
    filters.create(is_member_filter) & filters.create(ban_check_filter) & filters.create(search_credit_filter))
